...
export default function App() {
  ...
  const [board, setBoard] = useState<Board>(() => generatePuzzle());
    ...
    <div className="container">
      ...
      <div className="left-panel">
        ...
        <div className="controls">
          ...
          {/* SOLVE BUTTON */}
          <button onClick={handleSolve}disabled={isSolving || isCompleted}>  { isSolving && !isPaused ? "Solving..." : isPaused ? "Resume Solving" : "Start Solving" }</button>
